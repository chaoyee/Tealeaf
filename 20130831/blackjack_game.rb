...
#
def screen_show dealer_cards, player_cards, name  
  puts "-----------------------------------"
...
while play 
  ...
  while player_hit && ( player_busted == false )    # player turn
    dealer_sum = calculate_sum dealer_cards
    player_sum = calculate_sum player_cards
    screen_show dealer_cards, player_cards, name  
  ...
  while dealer_hit && ( dealer_busted == false ) && ( player_busted == false )   # dealer turn
  ...
  if player_busted 
    result = "#{name}, You busted, the dealer wins!"
  elsif dealer_busted
    result = "The dealer busted! #{name}, you win!" 
